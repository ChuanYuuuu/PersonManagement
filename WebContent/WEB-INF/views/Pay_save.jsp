			...
			<div class="col-md-12 column">
				...
				<div class="row clearfix">
					...
					<div class="col-md-12 column">
						...
						<form action="${pageContext.request.contextPath}/pay_save.action"
							method="post">
							<table class="table">
								<tr>
									<td>员工编号</td>
								...
								<tr>
									<td>工资发放时间</td>
									<td><input type="date" name="payTime" /></td>
								</tr>
								<tr>
									<td>基本工资</td>
								...
								<tr>
									<td>加班工资</td>
									<td><input type="text" name="salAdd" /></td>
								</tr>
								<tr>
									<td>缺勤扣除</td>
									<td><input type="text" name="salSub" /></td>
								</tr>
								<tr>
