					...
					<div class="col-md-12 column">
						...
						<form
							...
							<table>
								<tr>
									<td>部门编号</td>
									<td>${dept.deptno}<input type="hidden" name="deptno"
										value="${dept.deptno}" />
									</td>
								</tr>
								<tr>
									<td>部门名称</td>
									<td><input type="text" name="dname" value="${dept.dname}" />
									</td>
								</tr>
								<tr>
									<td>部门描述</td>
									<td><input type="text" name="ddesc" value="${dept.ddesc}" /></td>
								</tr>
								<tr>
									<td>部门经理</td>
									<td><input type="text" name="managerName"
										value="${dept.managerName}" /></td>
								</tr>
								<tr>
