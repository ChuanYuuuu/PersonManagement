...
public class LeaveDaoImpl implements LeaveDao{
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Leave> findByEmpno(int empno) throws Exception {
		return sessionFactory.getCurrentSession().createQuery("from Leave where empno=?").setParameter(0, empno).list();
	}
