...
public class CheckDaoImpl implements CheckDao{
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Check> findByEmpno(int empno) throws Exception {
		// TODO Auto-generated method stub
		return sessionFactory.getCurrentSession().createQuery("from Check where empno=?").setParameter(0, empno).list();
	}
